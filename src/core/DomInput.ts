...
export class DomInput {
    ...
    constructor(DomInputoptions: IUploader.DomInputOptions) {
        ...
        this.DomInputoptions.inputProps = Object.assign(
            _createInputProps(),
            DomInputoptions.inputProps || {}
        );
    ...
    protected addTriggerEvent() {
        this.DomInputoptions.el =
            this.DomInputoptions.el ||
            (document.querySelector(
                `#${this.DomInputoptions.id}`
            ) as HTMLElement);
        this.DomInputoptions.triggerEventListener = (e: MouseEvent) => {
            this.DomInputoptions.inputEl!.click();
        };
        this.DomInputoptions.el.addEventListener(
            CLICK,
            this.DomInputoptions.triggerEventListener
        );
    }
    ...
    protected mountedInputEvent(cb: (e: any) => void) {
        ...
        this.DomInputoptions.inputEl!.addEventListener(
            CHANGE,
    ...
    public removeTriggerEvent() {
        this.DomInputoptions.el!.removeEventListener(
            CLICK,
            this.DomInputoptions.triggerEventListener!
        );
        this.DomInputoptions.inputEl!.removeEventListener(
            CHANGE,
            this.DomInputoptions.inputEventListener!
        );
    ...
    protected createInput(
        domInputoptions: IUploader.DomInputOptions
    ): HTMLInputElement {
        ...
        if (el) {
            el =
                el instanceof HTMLInputElement
                    ? el
                    : this.createHiddenInput(domInputoptions);
        } else {
